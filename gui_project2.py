...
player_label = tk.Label(window, text="Current player: " + current_player)
player_label.pack()

score_label = tk.Label(window, text="Score: " + str(game_state))
score_label.pack()

subtraction_label = tk.Label(window, text="Subtraction: " + str(subtraction_state))
...
def update_scores():
    score_label.config(text="Score: " + str(game_state))
    subtraction_label.config(text="Subtraction: " + str(subtraction_state))
...
def update_game_state():
    score_label.config(text="Current game state: " + str(game_state))
    for button in score_buttons:
